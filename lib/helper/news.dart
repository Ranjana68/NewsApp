...
class News {
  ...
  Future<void> getNews() async{
    String countryCode;
    await getCountryName().then((value){
      countryCode = value.toString();
    });

    String url = "http://newsapi.org/v2/top-headlines?country=$countryCode&excludeDomains=stackoverflow.com&sortBy=publishedAt&language=en&apiKey=${apiKey}";
